CREATE TABLE account_book.budget_categories (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    user_id BIGINT UNSIGNED NOT NULL COMMENT '사용자 아이디',
    name VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '예산 카테고리명',
...
CREATE TABLE account_book.budget_categories_aud (
